...
{'title': 'Image2GPS', 'description': 'Trained CNNs to predict GPS from campus images using PyTorch; built data pipeline using Hugging Face Datasets and EXIF metadata to create reproducible Parquet datasets.', 'role': 'ML Researcher', 'techStack': ['PyTorch', 'Python', 'Hugging Face'], 'timeline': 'Mar 2025 – May 2025', 'category': ['AI/ML'], 'image': '/images/projects/image2gps.png', 'link': 'https://drive.google.com/drive/folders/11dnTVAkNAWsPu0D-JLMO7Uz_rMTE8kwj', 'display': true}, 
{'title': 'Docky – Chrome Extension', 'description': 'Built a fun productivity Chrome extension integrated with LLMs using JavaScript APIs.', 'role': 'Software Developer', 'techStack': ['JavaScript', 'Chrome APIs', 'LLM APIs'], 'timeline': 'Apr 2025 – May 2025', 'category': ['Software Development'], 'image': '/images/projects/docky.png', 'link': 'https://github.com/christianishimwe/Docky', 'display': true}, 
 {'title': 'Trading Simulator', 'description': 'Simulated live and historical trading using Alpaca API, OHLCV candlestick logic, and market strategies. Completed the IMC 30-Day Trading Challenge.', 'role': 'Quant Developer', 'techStack': ['Python', 'Alpaca API', 'Pandas'], 'timeline': 'Mar 2025 – Mar 2025', 'category': ['Software Development'], 'image': '/images/projects/trading.png', 'link': '/projects/trading', 'display': false}]
